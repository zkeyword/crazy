...
// Create 创建文章
func (r *BannerRepository) Create(t *model.Banner) (*model.Banner, error) {
	_db, err := db.GetMysql()
	if err != nil {
		return t, err
	}
...
// UpdateById 修改文章
func (r *BannerRepository) UpdateById(id int64, t *model.Banner) (*model.Banner, error) {
	var ret = new(model.Banner)
	_db, err := db.GetMysql()
	if err != nil {
		return ret, err
	}
...
// Get 获取文章
func (r *BannerRepository) Get(page int, pageSize int, title string) ([]model.Banner, error) {
